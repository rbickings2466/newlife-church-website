// Full knowledge base documents for Ask New Life chatbot

export const doc1 = `A BRIEF HISTORY OF THE BIBLE FELLOWSHIP CHURCH
...
export const doc2 = `NEW LIFE BIBLE FELLOWSHIP CHURCH - KNOWLEDGE DOCUMENT
...
export const KNOWLEDGE_BASE = `${doc1}
