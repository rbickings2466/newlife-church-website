...
const SmallGroupsSection = ({ setActiveSection }) => {
  const groups = [
    ...
    },
    {
      ...
      leader: "Pat Petrecca & Louise Bertolet",
    ...
    },
    {
      ...
      location: "Various Homes",
      description:
        "Families meet for a fellowship meal, bible study, and prayer.",
      leader: "Church Elders",
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {whySmallGroups.map((reason, index) => (
              ...
              >
                ...
                <h4 className='font-bold text-gray-900 mb-3'>{reason.title}</h4>
